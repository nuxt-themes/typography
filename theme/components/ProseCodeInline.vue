...
code {
  ...
  padding: v-bind($dt('prose.code-inline.padding'));
  font-size: v-bind($dt('prose.code-inline.font-size'));
  font-weight: v-bind($dt('prose.code-inline.font-weight'));
}
...
a {
  ...
  code {
    ...
    font-weight: v-bind($dt('prose.a.font-weight'));
  }
}
