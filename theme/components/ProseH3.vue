...
h3 {
  ...
  color: v-bind($dt('prose.h3.color'));
  margin: v-bind($dt('prose.h3.margin'));
  font-size: v-bind($dt('prose.h3.font-size'));
  font-weight: v-bind($dt('prose.h3.font-weight'));
  line-height: v-bind($dt('prose.h3.line-height'));
}
...
h3 > a {
  ...
  &:hover {
    &:before {
      border-bottom: v-bind($dt('prose.h3.hover-border-bottom'));
    }
    &:after {
      position: absolute;
      right: 1.25rem;
