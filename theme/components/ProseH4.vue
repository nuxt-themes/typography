...
h4 {
  ...
  color: v-bind($dt('prose.h4.color'));
  margin: v-bind($dt('prose.h4.margin'));
  font-size: v-bind($dt('prose.h4.font-size'));
  font-weight: v-bind($dt('prose.h4.font-weight'));
  line-height: v-bind($dt('prose.h4.line-height'));
}
...
h4 > a {
  ...
  &:hover {
    &:before {
      border-bottom: v-bind($dt('prose.h4.hover-border-bottom'));
    }
    &:after {
      position: absolute;
      right: 1.25rem;
